...
export const AvatarKu = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    id="Layer_1"
    width="4em"
    ...
    data-name="Layer 1"
    viewBox="0 0 128 128"
    className={` h-auto mr-5 ${className}`}
    {...rest}
  >
    <defs>
      <style>
        {
          ".cls-3{fill:#393c54}.cls-4{fill:#fba875}.cls-5{fill:#fff}.cls-8,.cls-9{fill:none;stroke-linecap:round}.cls-9{stroke:#fba875;stroke-miterlimit:10}.cls-8{stroke:#515570;stroke-linejoin:round;stroke-width:2px;opacity:.4}.cls-9{stroke-width:4px}.cls-11{fill:#515570}"
        }
      </style>
    </defs>
    <title />
    ...
    <path
      ...
      className="cls-3"
    />
    <circle cx={91.32} cy={60.43} r={7.93} className="cls-4" />
    <path
    ...
    />
    <circle cx={36.68} cy={60.43} r={7.93} className="cls-4" />
    <path
    ...
    />
    <circle cx={76.67} cy={59.28} r={3} className="cls-3" />
    <circle cx={49.67} cy={59.28} r={3} className="cls-3" />
    <path d="m74.39 53 9.61-.25M53 53l-9.61-.25" className="cls-8" />
    <path
      d="M71.55 74a1 1 0 0 1 .94 1.07 8.56 8.56 0 0 1-17 0 1 1 0 0 1 .96-1.07Z"
      className="cls-3"
    />
    <path d="M60 86h8" className="cls-8" />
    <path d="M63.35 60.75v6.5M66 68h-5" className="cls-9" />
    <path
...
export const Contactsini = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={400}
    height={400}
...
export const InstaIcon2 = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
